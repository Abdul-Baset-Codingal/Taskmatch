                            ...
                            <div className="order-1 md:order-2">
                                ...
                                <div className="p-6 bg-gradient-to-r from-[#063A41] to-[#109C3D] rounded-xl text-white">
                                    ...
                                    <div className="flex gap-3">
                                        ...
                                        <a href="https://www.facebook.com/profile.php?id=61585575984069" className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center hover:bg-white/30 transition-colors duration-300">
                                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" /></svg>
                                        </a>
                                        <a href="https://www.instagram.com/taskallo/" className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center hover:bg-white/30 transition-colors duration-300">
