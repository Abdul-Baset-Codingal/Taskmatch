...
const HowTaskMatchWorks = () => {
  return (
    <div className="w-full bg-gradient-to-r from-[#6F3DE9] to-[#5714E0] relative overflow-hidden py-8 sm:py-14 md:py-20 px-4 sm:px-6 md:px-10 xl:px-20">
      {/* Top-right bubble */}
      <div className="absolute -top-12 -right-12 w-24 h-24 md:w-[250px] md:h-[250px] bg-[#7A51EE] rounded-full opacity-30"></div>
      ...
      <div className="text-center max-w-3xl mx-auto">
        ...
        <div className="flex justify-center mt-2 sm:mt-3">
          <div className="h-1.5 w-14 sm:w-20 md:w-24 bg-gradient-to-r from-[#8560F1] to-[#E7B6FE] rounded-md" />
        </div>
        <p className="mt-3 text-white text-sm sm:text-base md:text-xl font-semibold">
            ...
            {cardData.map((card, index) => (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <h2 className="hidden sm:block text-white/50 text-4xl md:text-6xl font-bold leading-none">
                    {index + 1}
                  </h2>
                  ...
                  {index === 0 ? (
                    <p className="text-white/80 text-xs sm:text-sm md:text-base leading-relaxed">
                      ...
                      <br />
                      <br />
                      <span className="text-[#FF8906] font-bold">Book Directly</span>{" "}
