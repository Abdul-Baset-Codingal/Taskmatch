...
import BeautyWellnessBookingForm from "./BeautyWellnessBookingForm";

const BeautyBanner = () => {
 const [clipPath, setClipPath] = useState(
     "polygon(0 0, 100% 0, 100% 210vh, 0 220vh)"
   );
   const [height, setHeight] = useState("220vh");
 
   useEffect(() => {
     const updateClipPath = () => {
       if (window.innerWidth < 768) {
         setClipPath("polygon(0 0, 100% 0, 100% 340vh, 0 350vh)");
         setHeight("350vh");
       } else {
         setClipPath("polygon(0 0, 100% 0, 100% 210vh, 0 220vh)");
         setHeight("220vh");
       }
     };
         ...
         <div className="flex items-center max-w-6xl mx-auto gap-16 w-full justify-center flex-col lg:flex-row px-4">
           ...
           <div className="text-white max-w-lg">
             ...
             <p className="text-lg font-semibold mt-3">
               Indulge in expert beauty treatments and wellness therapies
               designed to rejuvenate your mind, body, and spirit — all
               delivered with elegance and care.
             </p>
