import { FaCheck, FaTools, FaBolt, FaPaintRoller } from "react-icons/fa";

export default function HandymanPackagesSection() {
  return (
    <div className="bg-gradient-to-r from-[#7F5AEF] to-[#6548B1] py-20 rounded-3xl">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 px-6 lg:px-12">
        <div>
          ...
          <p className="text-white text-sm  mb-5">Choose one of our popular packages below!</p>
          {/* Left Side – Handyman Package Cards */}
          <div className="space-y-8">
            {[
              {
                title: "Basic Repair",
                price: "$100",
                details: ["1 Hour", "1 Technician"],
                badge: "Most Popular",
              ...
              },
              {
                ...
                price: "$200",
                details: ["3 Hours", "2 Technicians"],
                badge: "Thorough",
                badgeColor: "bg-white/20 text-white",
                icon: <FaPaintRoller className="text-yellow-300" />,
              },
            ].map((card, idx) => (
              <div
                key={idx}
        ...
        {/* Right Side – Handyman Booking Form */}
        <div className="bg-white rounded-3xl p-10 shadow-2xl space-y-6">
          <div className="flex justify-between items-center">
            <h2 className="text-2xl font-bold text-gray-800">
              Book Basic Repair
            </h2>
            <p className="text-3xl text-[#6548B1] font-bold">$100</p>
          </div>
