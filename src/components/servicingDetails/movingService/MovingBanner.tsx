...
import MovingBookingForm from "./MovingBookingForm";
        ...
        <div className="flex items-center max-w-6xl mx-auto gap-16  w-full justify-center">
          ...
          <div className="text-white max-w-lg">
            ...
            <p className="text-lg font-semibold mt-3">
              Reliable, efficient movers to help with your local or
              long-distance relocation. From apartments to houses, we&#39;ve got you
              covered.
            </p>
