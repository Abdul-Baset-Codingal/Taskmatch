...
const PaymentFormContent: React.FC<PaymentFormProps> = ({
    ...
    useEffect(() => {
        const loadCards = async () => {
            try {
                const response = await fetch('/api/payments/client/methods', {
                    credentials: 'include'
                });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const intentResponse = await fetch('/api/payments/client/setup-intent', {
                method: 'POST',
                credentials: 'include',
            ...
            const saveResponse = await fetch('/api/payments/client/save', {
                method: 'POST',
                credentials: 'include',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
